...
import { WindowIsNormal, WindowIsMinimised, WindowIsMaximised, WindowIsFullscreen} from "../wailsjs/runtime/runtime.js";
...
const getWindowState = () => {
  return Promise.all([WindowIsNormal(), WindowIsMinimised(), WindowIsMaximised(), WindowIsFullscreen()]).then((result) => {
